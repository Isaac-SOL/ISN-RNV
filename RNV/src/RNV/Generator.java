    ...
    public static Network mutate(Network firstNet) {
        ...
        switch  (choice){
            ...
            case 1 :
                ...
                firstNet.newNeuronFromTile(inputId, type, dest, false); break ; // créer un nouveau neurone avec des caractéristiques tirées au hasard et le rajoute dans firstNet
        }   
